        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $delete_open = '';
                    $delete_close = '';
                    if(auth()->user()->can('professor-edit')) {
                    ...
                    if(auth()->user()->can('professor-delete')) {
                        ...
                        $delete_close = csrf_field() . ' <input type="hidden" name="_method" value="DELETE"><button type="submit" class="delete btn btn-danger btn-sm" title="Remover" onclick="return confirm(\'Tem certeza que deseja remover o professor '. $row->name .'?\')"><i class="fa fa-trash"></i></button> </form>';
                    }
